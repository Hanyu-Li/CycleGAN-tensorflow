...
parser.add_argument('--dataset_dir', dest='dataset_dir', default=None, help='abs path of the dataset')
...
parser.add_argument('--save_freq', dest='save_freq', type=int, default=200, help='save a model every save_freq iterations')
